...
! function(t, e, i) {
    L.MarkerClusterGroup = L.FeatureGroup.extend({
            ...
            addLayer: function(t) {
                ...
                this._unspiderfy && this._unspiderfy(), this._addLayer(t, this._maxZoom), this._topClusterLevel._recalculateBounds();
                var n = t,
                    s = this._map.getZoom();
                if (t.__parent)
            ...
            removeLayers: function(t) {
                ...
                if (!this._map) {
                    for (e = 0, i = t.length; i > e; e++) n = t[e], this._arraySplice(this._needsClustering, n), r.removeLayer(n), this.hasLayer(n) && this._needsRemoving.push(n);
                    return this
                }
                if (this._unspiderfy)
                    for (this._unspiderfy(), e = 0, i = t.length; i > e; e++) n = t[e], this._unspiderfyLayer(n);
                for (e = 0, i = t.length; i > e; e++) n = t[e], n.__parent ? (this._removeLayer(n, !0, !0), s.hasLayer(n) && (s.removeLayer(n), n.clusterShow && n.clusterShow())) : r.removeLayer(n);
            ...
            onAdd: function(t) {
                ...
                for (this._featureGroup.onAdd(t), this._nonPointGroup.onAdd(t), this._gridClusters || this._generateInitialClusters(), this._maxLat = t.options.crs.projection.MAX_LATITUDE, e = 0, i = this._needsRemoving.length; i > e; e++) n = this._needsRemoving[e], this._removeLayer(n, !0);
            ...
            _addLayer: function(t, e) {
                ...
                for (this.options.singleMarkerMode && this._overrideMarkerIcon(t); e >= 0; e--) {
                    ...
                    if (o = r[e].getNearObject(i)) {
                        ...
                        var u = h;
                        for (n = e - 1; n > a._zoom; n--) u = new this._markerCluster(this, n, u), s[n].addObject(u, this._map.project(o.getLatLng(), n));
            ...
            _checkBoundsMaxLat: function(t) {
                var e = this._maxLat;
                return e !== i && (t.getNorth() >= e && (t._northEast.lat = 1 / 0), t.getSouth() <= -e && (t._southWest.lat = -1 / 0)), t
            },
            ...
            _withAnimation: {
                ...
                _animationZoomIn: function(t, e) {
                    ...
                    this._topClusterLevel._recursively(n, t, 0, function(r) {
                        var o, a = r._latlng,
                            h = r._markers;
                        for (n.contains(a) || (a = null), r._isSingleParent() && t + 1 === e ? (s.removeLayer(r), r._recursivelyAddChildrenToMap(null, e, n)) : (r.clusterHide(), r._recursivelyAddChildrenToMap(a, e, n)), i = h.length - 1; i >= 0; i--) o = h[i], n.contains(o._latlng) || s.removeLayer(o)
            ...
            _animationZoomOutSingle: function(t, e, i) {
                ...
                this._forceLayout(), t._recursivelyBecomeVisible(n, i), this._enqueue(function() {
                    if (1 === t._childCount) {
                        var r = t._markers[0];
                        r.setLatLng(r.getLatLng()), r.clusterShow && r.clusterShow()
            ...
            _recalculateBounds: function() {
                var t, e, i, n, s = this._markers,
                    r = this._childClusters,
                    o = 0,
                    a = 0,
                    h = this._childCount;
                if (0 !== h) {
                    for (this._resetBounds(), t = 0; t < s.length; t++) i = s[t]._latlng, this._bounds.extend(i), o += i.lat, a += i.lng;
                    for (t = 0; t < r.length; t++) e = r[t], e._boundsNeedUpdate && e._recalculateBounds(), this._bounds.extend(e._bounds), i = e._wLatLng, n = e._childCount, o += i.lat * n, a += i.lng * n;
            ...
            _recursivelyAnimateChildrenIn: function(t, e, i) {
                this._recursively(t, 0, i - 1, function(t) {
                    ...
                    for (i = s.length - 1; i >= 0; i--) n = s[i], n._icon && (n._setPos(e), n.clusterHide())
                }, function(t) {
                ...
                this._recursively(i, -1, e, function(n) {
                    if (e !== n._zoom)
                        for (var s = n._markers.length - 1; s >= 0; s--) {
                            var r = n._markers[s];
                            i.contains(r._latlng) && (t && (r._backupLatlng = r.getLatLng(), r.setLatLng(t), r.clusterHide && r.clusterHide()), n._group._featureGroup.addLayer(r))
                        }
                }, function(e) {
                    e._addToMap(t)
                })
            ...
            _recursivelyRemoveChildrenFromMap: function(t, e, i) {
                ...
                this._recursively(t, -1, e - 1, function(t) {
                    for (s = t._markers.length - 1; s >= 0; s--) n = t._markers[s], i && i.contains(n._latlng) || (t._group._featureGroup.removeLayer(n), n.clusterShow && n.clusterShow())
                }, function(t) {
                    for (s = t._childClusters.length - 1; s >= 0; s--) n = t._childClusters[s], i && i.contains(n._latlng) || (t._group._featureGroup.removeLayer(n), n.clusterShow && n.clusterShow())
                })
            },
            ...
            getNearObject: function(t) {
                var e, i, n, s, r, o, a, h, u = this._getCoord(t.x),
                ...
                for (e = _ - 1; _ + 1 >= e; e++)
                    if (s = this._grid[e])
                        for (i = u - 1; u + 1 >= i; i++)
                            if (r = s[i])
                                for (n = 0, o = r.length; o > n; n++) a = r[n], h = this._sqDist(l[L.Util.stamp(a)], t), d > h && (d = h, c = a);
                return c
            },
        ...
        function() {
            L.QuickHull = {
                ...
                getConvexHull: function(t) {
                    ...
                    n !== i ? (l = a, _ = o) : (l = u, _ = h);
                    var c = [].concat(this.buildConvexHull([l, _], t), this.buildConvexHull([_, l], t));
                    return c
                }
            }
            ...
            _generatePointsSpiral: function(t, e) {
                var i, n = this._group.options.spiderfyDistanceMultiplier,
                    ...
                    a = 0,
                    h = [];
                for (h.length = t, i = t - 1; i >= 0; i--) a += r / s + 5e-4 * i, h[i] = new L.Point(e.x + s * Math.cos(a), e.y + s * Math.sin(a))._round(), s += o / a;
                return h
            },
            ...
            _animationSpiderfy: function(t, e) {
                ...
                for (i = 0; i < t.length; i++) r = a.layerPointToLatLng(e[i]), n = t[i], s = new L.Polyline([this._latlng, r], u), a.addLayer(s), n._spiderLeg = s, n._preSpiderfyLatlng = n._latlng, n.setLatLng(r), n.setZIndexOffset && n.setZIndexOffset(1e6), h.addLayer(n);
            ...
            _animationSpiderfy: function(t, e) {
                ...
                for (_._forceLayout(), _._animationStart(), n = t.length - 1; n >= 0; n--) h = l.layerPointToLatLng(e[n]), s = t[n], s._preSpiderfyLatlng = s._latlng, s.setLatLng(h), s.clusterShow && s.clusterShow(), f && (r = s._spiderLeg, o = r._path, o.style.strokeDashoffset = 0, r.setStyle({
                    opacity: g
                }));
            ...
            _animationUnspiderfy: function(t) {
                var e, i, n, s, r, o, a = this,
                    ...
                    c = L.Path.SVG;
                for (h._animationStart(), this.setOpacity(1), i = d.length - 1; i >= 0; i--) e = d[i], e._preSpiderfyLatlng && (e.setLatLng(e._preSpiderfyLatlng), delete e._preSpiderfyLatlng, o = !0, e._setPos && (e._setPos(l), o = !1), e.clusterHide && (e.clusterHide(), o = !1), o && _.removeLayer(e), c && (n = e._spiderLeg, s = n._path, r = s.getTotalLength() + .1, s.style.strokeDashoffset = r, n.setStyle({
                    opacity: 0
                })));
                setTimeout(function() {
                    var t = 0;
                    for (i = d.length - 1; i >= 0; i--) e = d[i], e._spiderLeg && t++;
                    for (i = d.length - 1; i >= 0; i--) e = d[i], e._spiderLeg && (e.clusterShow && e.clusterShow(), e.setZIndexOffset && e.setZIndexOffset(0), t > 1 && _.removeLayer(e), u.removeLayer(e._spiderLeg), delete e._spiderLeg);
